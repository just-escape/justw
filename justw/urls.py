...
urlpatterns = i18n_patterns(
    ...
    path('qui-est-loup-garou', views.qui_est_loup_garou, name='qui_est_loup_garou'),
    ...
    path('blog/murder-party-evjf', views.blog_murder_party_evjf, name='blog-murder-party-evjf'),
    path('blog/murder-party-ou-escape-game-evjf', views.blog_murder_party_ou_escape_game_evjf, name='blog-murder-party-ou-escape-game-evjf'),
    path('blog/meilleures-activites-evjf-lille', views.blog_meilleures_activites_evjf_lille, name='blog-meilleures-activites-evjf-lille'),
